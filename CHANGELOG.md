...
### Added
- Added the `barsAllowedFields` plugin setting, for setting handles of Matrix or Neo fields that should be the only ones given a batch actions bar (previously added in 1.4.0)
